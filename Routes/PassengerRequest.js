...
const { postRequest, approvePassengerRequest, getPassengerRequests, declineRequest, getRequestsByPassengerId } = require('../Controllers/PassengerRequest');
const router = express.Router();

router.post('/passenger/request', Authenticate,postRequest);
router.get("/passenger/request", Authenticate, getRequestsByPassengerId);
